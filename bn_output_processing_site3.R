...
#### Load model results ####
E_input <- read.table("data/site3_1000_to_4000.txt", header=FALSE)
E_output <- read.csv("output/site3/E_q_all_prob_mn.csv", header=TRUE)
CUFA_150_output <- read.csv("output/site3/CUFA_150_q_all_prob_mn.csv", header=TRUE)
CUFA_nomin_output <- read.csv("output/site3/CUFA_nomin_q_all_prob_mn.csv", header=TRUE)
nrow(E_output)
...
load("output/site3/E_q1_cell_probs.Rdata")
load("output/site3/E_q2_cell_probs.Rdata")
load("output/site3/E_q3_cell_probs.Rdata")
load("output/site3/E_q4_cell_probs.Rdata")
load("output/site3/E_q5_cell_probs.Rdata")
load("output/site3/E_q6_cell_probs.Rdata")
load("output/site3/E_q7_cell_probs.Rdata")

load("output/site3/CUFA_150_q1_cell_probs.Rdata")
load("output/site3/CUFA_150_q2_cell_probs.Rdata")
load("output/site3/CUFA_150_q3_cell_probs.Rdata")
load("output/site3/CUFA_150_q4_cell_probs.Rdata")
load("output/site3/CUFA_150_q5_cell_probs.Rdata")
load("output/site3/CUFA_150_q6_cell_probs.Rdata")
load("output/site3/CUFA_150_q7_cell_probs.Rdata")

load("output/site3/CUFA_nomin_q1_cell_probs.Rdata")
load("output/site3/CUFA_nomin_q2_cell_probs.Rdata")
load("output/site3/CUFA_nomin_q3_cell_probs.Rdata")
load("output/site3/CUFA_nomin_q4_cell_probs.Rdata")
load("output/site3/CUFA_nomin_q5_cell_probs.Rdata")
load("output/site3/CUFA_nomin_q6_cell_probs.Rdata")
load("output/site3/CUFA_nomin_q7_cell_probs.Rdata")

load("output/site3/E_evidence1.Rdata")
load("output/site3/E_evidence2.Rdata")
load("output/site3/E_evidence3.Rdata")
load("output/site3/E_evidence4.Rdata")
load("output/site3/E_evidence5.Rdata")
load("output/site3/E_evidence6.Rdata")
load("output/site3/E_evidence7.Rdata")

load("output/site3/CUFA_150_evidence1.Rdata")
load("output/site3/CUFA_150_evidence2.Rdata")
load("output/site3/CUFA_150_evidence3.Rdata")
load("output/site3/CUFA_150_evidence4.Rdata")
load("output/site3/CUFA_150_evidence5.Rdata")
load("output/site3/CUFA_150_evidence6.Rdata")
load("output/site3/CUFA_150_evidence7.Rdata")

load("output/site3/CUFA_nomin_evidence1.Rdata")
load("output/site3/CUFA_nomin_evidence2.Rdata")
load("output/site3/CUFA_nomin_evidence3.Rdata")
load("output/site3/CUFA_nomin_evidence4.Rdata")
load("output/site3/CUFA_nomin_evidence5.Rdata")
load("output/site3/CUFA_nomin_evidence6.Rdata")
load("output/site3/CUFA_nomin_evidence7.Rdata")
...
site3_xy <- read.table("data/coordinates/site3_coords_1000_to_4000.txt", header=TRUE)

# Trim x,y coordinate data so only cells with model outputs are included
site3_xy_trim <- site3_xy[site3_xy[ ,3] %in% E_output[ ,1],]

# Combine the coordinate and results data
CUFA_150_gis <- data.frame(site3_xy_trim, 
...
write.table(CUFA_150_gis, file = "output/site3/CUFA_150_gis_site3.txt", sep = "\t",  row.names = FALSE)

CUFA_nomin_gis <- data.frame(site3_xy_trim, 
                             existing_prob = E_output[, 2], 
...
write.table(CUFA_nomin_gis, file = "output/site3/CUFA_nomin_gis_site3.txt", sep = "\t",  row.names = FALSE)
...
writeOGR(CUFA_150_gis, "/Users/Morrison/Documents/GIS/Projects/gila bn/shapefiles/site3", "CUFA_150_site3", driver="ESRI Shapefile", overwrite_layer=TRUE)
writeOGR(CUFA_nomin_gis, "/Users/Morrison/Documents/GIS/Projects/gila bn/shapefiles/site3", "CUFA_nomin_site3", driver="ESRI Shapefile", overwrite_layer=TRUE)
...
# Combine model ouput
E_site3 <- data.frame(combine.probs.E(), scenario = "existing")
CUFA_150_site3 <- data.frame(combine.probs.CUFA.150(), scenario = "CUFA_150")
CUFA_nomin_site3 <- data.frame(combine.probs.CUFA.nomin(), scenario = "CUFA_nomin")
combined_site3 <- data.frame(rbind(E_site3, CUFA_150_site3, CUFA_nomin_site3), site = "site3")

# Calculate and combine evidence in each cell
E_lengths_site3 <- combine.lengths.E()
CUFA_150_lengths_site3 <- combine.lengths.CUFA.150()
CUFA_nomin_lengths_site3 <- combine.lengths.CUFA.nomin()

# Calculate difference in events
E_lengthsdiff_site3 <- (E_lengths_site3[ ,1] - E_lengths_site3[ ,1])/E_lengths_site3[ ,1] * 100
CUFA_150_lengthsdiff_site3 <- (E_lengths_site3[ ,1] - CUFA_150_lengths_site3[ ,1])/E_lengths_site3[ ,1] * 100
CUFA_nomin_lengthsdiff_site3 <- (E_lengths_site3[ ,1] - CUFA_nomin_lengths_site3[ ,1])/E_lengths_site3[ ,1] * 100

# Apply utility function to calculate percent decrease in probabilities
E_utility_site3 <- utility_ftn(E_lengthsdiff_site3)
CUFA_150_utility_site3 <- utility_ftn(CUFA_150_lengthsdiff_site3)
CUFA_nomin_utility_site3 <- utility_ftn(CUFA_nomin_lengthsdiff_site3)

# Apply utility function decreases to probabilities
E_util_site3 <- E_site3[ ,1] * E_utility_site3
CUFA_150_util_site3 <- CUFA_150_site3[ ,1] * CUFA_150_utility_site3
CUFA_nomin_util_site3 <- CUFA_nomin_site3[ ,1] * CUFA_nomin_utility_site3

# Count the number of events in each month
E_all_events_site3 <- c(E_evidence1, E_evidence2, E_evidence3, E_evidence4, E_evidence5, E_evidence6, E_evidence7)
CUFA_150_all_events_site3 <- c(CUFA_150_evidence1, CUFA_150_evidence2, CUFA_150_evidence3, CUFA_150_evidence4, CUFA_150_evidence5, CUFA_150_evidence6, CUFA_150_evidence7)
CUFA_nomin_all_events_site3 <- c(CUFA_nomin_evidence1, CUFA_nomin_evidence2, CUFA_nomin_evidence3, CUFA_nomin_evidence4, CUFA_nomin_evidence5, CUFA_nomin_evidence6, CUFA_nomin_evidence7)

E_count_site3 <- countevents(E_all_events_site3)
CUFA_150_count_site3 <- countevents(CUFA_150_all_events_site3)
CUFA_nomin_count_site3 <- countevents(CUFA_nomin_all_events_site3)

# Make one large data frame with all the data
E_site3 <- data.frame(prob = E_site3$prob, 
                      util_prob = E_util_site3, 
                      prob_diff = E_util_site3 - E_site3$prob, 
                      evidence = E_lengths_site3$evidence,
                      E_count_site3,
                      Q_bin = E_site3$Q_bin, 
                      scenario = E_site3$scenario)
CUFA_150_site3 <- data.frame(prob = CUFA_150_site3$prob, 
                             util_prob = CUFA_150_util_site3, 
                             prob_diff = CUFA_150_util_site3 - E_site3$prob, 
                             evidence = CUFA_150_lengths_site3$evidence, 
                             CUFA_150_count_site3,
                             Q_bin = CUFA_150_site3$Q_bin, 
                             scenario = CUFA_150_site3$scenario)
CUFA_nomin_site3 <- data.frame(prob = CUFA_nomin_site3$prob, 
                               util_prob = CUFA_nomin_util_site3,
                               prob_diff = CUFA_nomin_util_site3 - E_site3$prob,
                               evidence = CUFA_nomin_lengths_site3$evidence,
                               CUFA_nomin_count_site3,
                               Q_bin = CUFA_nomin_site3$Q_bin, 
                               scenario = CUFA_nomin_site3$scenario)
combined_site3 <- data.frame(rbind(E_site3, CUFA_150_site3, CUFA_nomin_site3), site = "site3")

# Export as .Rdata
save(combined_site3, file="output/combined_site3.Rdata")
