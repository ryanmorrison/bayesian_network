...
#### Load model results ####
E_input <- read.table("data/s3_1000_to_2000.txt", header=FALSE)
...
site3_xy <- read.table("data/coordinates/site3_cords.txt", header=TRUE)
...
writeOGR(CUFA_150_gis, "/Users/Morrison/Documents/GIS/Projects/gila bn/shapefiles/site3", "CUFA_150_gis", driver="ESRI Shapefile", overwrite_layer=TRUE)
