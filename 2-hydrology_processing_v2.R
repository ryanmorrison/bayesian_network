...
recess_1d <- recession.rate.forward(hydro, 1)
recess_2d <- recession.rate.forward(hydro, 2)
recess_3d <- recession.rate.forward(hydro, 3)
recess_4d <- recession.rate.forward(hydro, 4)
recess_5d <- recession.rate.forward(hydro, 5)
recess_6d <- recession.rate.forward(hydro, 6)
recess_7d <- recession.rate.forward(hydro, 7)
recess_14d <- recession.rate.forward(hydro, 14)
recess_30d <- recession.rate.forward(hydro, 30)
recess_45d <- recession.rate.forward(hydro, 45)
...
hydro <- cbind(hydro, recess_1d, recess_2d, recess_3d, recess_4d, recess_5d, recess_6d, recess_7d, recess_14d, recess_30d, recess_45d)
colnames(hydro)[5:14] <- c("recess_1d", "recess_2d", "recess_3d", "recess_4d", "recess_5d", "recess_6d", "recess_7d", "recess_14d", "recess_30d", "recess_45d")
...
q7_state <- q.states(hydro, q_bin, 7)

# Discrete states based on recession rates
recess_state <- recess.states(hydro, recess_rates, "recess_14d")
