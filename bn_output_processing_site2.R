...
#### Load model results ####
E_input <- read.table("data/site2_1000_to_4000.txt", header=FALSE)
E_output <- read.csv("output/site2/E_q_all_prob_mn.csv", header=TRUE)
CUFA_150_output <- read.csv("output/site2/CUFA_150_q_all_prob_mn.csv", header=TRUE)
CUFA_nomin_output <- read.csv("output/site2/CUFA_nomin_q_all_prob_mn.csv", header=TRUE)
nrow(E_output)
...
load("output/site2/E_q1_cell_probs.Rdata")
load("output/site2/E_q2_cell_probs.Rdata")
load("output/site2/E_q3_cell_probs.Rdata")
load("output/site2/E_q4_cell_probs.Rdata")
load("output/site2/E_q5_cell_probs.Rdata")
load("output/site2/E_q6_cell_probs.Rdata")
load("output/site2/E_q7_cell_probs.Rdata")

load("output/site2/CUFA_150_q1_cell_probs.Rdata")
load("output/site2/CUFA_150_q2_cell_probs.Rdata")
load("output/site2/CUFA_150_q3_cell_probs.Rdata")
load("output/site2/CUFA_150_q4_cell_probs.Rdata")
load("output/site2/CUFA_150_q5_cell_probs.Rdata")
load("output/site2/CUFA_150_q6_cell_probs.Rdata")
load("output/site2/CUFA_150_q7_cell_probs.Rdata")

load("output/site2/CUFA_nomin_q1_cell_probs.Rdata")
load("output/site2/CUFA_nomin_q2_cell_probs.Rdata")
load("output/site2/CUFA_nomin_q3_cell_probs.Rdata")
load("output/site2/CUFA_nomin_q4_cell_probs.Rdata")
load("output/site2/CUFA_nomin_q5_cell_probs.Rdata")
load("output/site2/CUFA_nomin_q6_cell_probs.Rdata")
load("output/site2/CUFA_nomin_q7_cell_probs.Rdata")

load("output/site2/E_evidence1.Rdata")
load("output/site2/E_evidence2.Rdata")
load("output/site2/E_evidence3.Rdata")
load("output/site2/E_evidence4.Rdata")
load("output/site2/E_evidence5.Rdata")
load("output/site2/E_evidence6.Rdata")
load("output/site2/E_evidence7.Rdata")

load("output/site2/CUFA_150_evidence1.Rdata")
load("output/site2/CUFA_150_evidence2.Rdata")
load("output/site2/CUFA_150_evidence3.Rdata")
load("output/site2/CUFA_150_evidence4.Rdata")
load("output/site2/CUFA_150_evidence5.Rdata")
load("output/site2/CUFA_150_evidence6.Rdata")
load("output/site2/CUFA_150_evidence7.Rdata")

load("output/site2/CUFA_nomin_evidence1.Rdata")
load("output/site2/CUFA_nomin_evidence2.Rdata")
load("output/site2/CUFA_nomin_evidence3.Rdata")
load("output/site2/CUFA_nomin_evidence4.Rdata")
load("output/site2/CUFA_nomin_evidence5.Rdata")
load("output/site2/CUFA_nomin_evidence6.Rdata")
load("output/site2/CUFA_nomin_evidence7.Rdata")
...
site2_xy <- read.table("data/coordinates/site2_coords_1000_to_4000.txt", header=TRUE)

# Trim x,y coordinate data so only cells with model outputs are included
site2_xy_trim <- site2_xy[site2_xy[ ,3] %in% E_output[ ,1],]

# Combine the coordinate and results data
CUFA_150_gis <- data.frame(site2_xy_trim, 
...
writeOGR(CUFA_150_gis, "/Users/Morrison/Documents/GIS/Projects/gila bn/shapefiles/site2", "CUFA_150_site2", driver="ESRI Shapefile", overwrite_layer=TRUE)
writeOGR(CUFA_nomin_gis, "/Users/Morrison/Documents/GIS/Projects/gila bn/shapefiles/site2", "CUFA_nomin_site2", driver="ESRI Shapefile", overwrite_layer=TRUE)
...
E_all_events_site2 <- c(E_evidence1, E_evidence2, E_evidence3, E_evidence4, E_evidence5, E_evidence6, E_evidence7)
CUFA_150_all_events_site2 <- c(CUFA_150_evidence1, CUFA_150_evidence2, CUFA_150_evidence3, CUFA_150_evidence4, CUFA_150_evidence5, CUFA_150_evidence6, CUFA_150_evidence7)
CUFA_nomin_all_events_site2 <- c(CUFA_nomin_evidence1, CUFA_nomin_evidence2, CUFA_nomin_evidence3, CUFA_nomin_evidence4, CUFA_nomin_evidence5, CUFA_nomin_evidence6, CUFA_nomin_evidence7)

E_count_site2 <- countevents(E_all_events_site2)
CUFA_150_count_site2 <- countevents(CUFA_150_all_events_site2)
CUFA_nomin_count_site2 <- countevents(CUFA_nomin_all_events_site2)

# Make one large data frame with all the data
E_site2 <- data.frame(prob = E_site2$prob, 
                      util_prob = E_util_site2, 
                      prob_diff = E_util_site2 - E_site2$prob, 
                      evidence = E_lengths_site2$evidence,
                      E_count_site2,
                      Q_bin = E_site2$Q_bin, 
                      scenario = E_site2$scenario)
CUFA_150_site2 <- data.frame(prob = CUFA_150_site2$prob, 
                             util_prob = CUFA_150_util_site2, 
                             prob_diff = CUFA_150_util_site2 - E_site2$prob, 
                             evidence = CUFA_150_lengths_site2$evidence, 
                             CUFA_150_count_site2,
                             Q_bin = CUFA_150_site2$Q_bin, 
                             scenario = CUFA_150_site2$scenario)
CUFA_nomin_site2 <- data.frame(prob = CUFA_nomin_site2$prob, 
                               util_prob = CUFA_nomin_util_site2,
                               prob_diff = CUFA_nomin_util_site2 - E_site2$prob,
                               evidence = CUFA_nomin_lengths_site2$evidence,
                               CUFA_nomin_count_site2,
                               Q_bin = CUFA_nomin_site2$Q_bin, 
                               scenario = CUFA_nomin_site2$scenario)
combined_site2 <- data.frame(rbind(E_site2, CUFA_150_site2, CUFA_nomin_site2), site = "site2")
