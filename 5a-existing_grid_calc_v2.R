...
E_alldata <- read.table("data/site4_1000_to_4000.txt", header=FALSE, skip=0)
...
save(E_hydro_states, file="output/site4/E_hydro_states.Rdata")
...
save(E_evidence1, file="output/site4/E_evidence1.Rdata")
save(E_evidence2, file="output/site4/E_evidence2.Rdata")
save(E_evidence3, file="output/site4/E_evidence3.Rdata")
save(E_evidence4, file="output/site4/E_evidence4.Rdata")
save(E_evidence5, file="output/site4/E_evidence5.Rdata")
save(E_evidence6, file="output/site4/E_evidence6.Rdata")
save(E_evidence7, file="output/site4/E_evidence7.Rdata")
...
save(E_q1_cell_probs, file="output/site4/E_q1_cell_probs.Rdata")
...
save(E_q2_cell_probs, file="output/site4/E_q2_cell_probs.Rdata")
...
save(E_q3_cell_probs, file="output/site4/E_q3_cell_probs.Rdata")
...
save(E_q4_cell_probs, file="output/site4/E_q4_cell_probs.Rdata")
...
save(E_q5_cell_probs, file="output/site4/E_q5_cell_probs.Rdata")
...
save(E_q6_cell_probs, file="output/site4/E_q6_cell_probs.Rdata")
...
save(E_q7_cell_probs, file="output/site4/E_q7_cell_probs.Rdata")
...
# Export File
write.csv(E_q_all_prob_mn, file="output/site4/E_q_all_prob_mn.csv")
E_q_all_prob_mn2 <- read.csv("output/site4/E_q_all_prob_mn.csv")
colnames(E_q_all_prob_mn2) <- c("cell","mean_prob")
E_q_all_prob_mn2 <- E_q_all_prob_mn2[order(E_q_all_prob_mn2$cell),]
write.csv(E_q_all_prob_mn2, file="output/site4/E_q_all_prob_mn.csv", row.names=FALSE)
