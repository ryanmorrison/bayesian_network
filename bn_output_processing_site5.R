...
write.table(CUFA_150_gis, file = "output/site5/CUFA_150_gis_site5.txt", sep = "\t",  row.names = FALSE)

CUFA_nomin_gis <- data.frame(site5_xy_trim, 
                             existing_prob = E_output[, 2], 
...
write.table(CUFA_nomin_gis, file = "output/site5/CUFA_nomin_gis_site5.txt", sep = "\t",  row.names = FALSE)
...
writeOGR(CUFA_150_gis, "/Users/Morrison/Documents/GIS/Projects/gila bn/shapefiles/site5", "CUFA_150_site5", driver="ESRI Shapefile", overwrite_layer=TRUE)
writeOGR(CUFA_nomin_gis, "/Users/Morrison/Documents/GIS/Projects/gila bn/shapefiles/site5", "CUFA_nomin_site5", driver="ESRI Shapefile", overwrite_layer=TRUE)
...
E_all_events_site5 <- c(E_evidence1, E_evidence2, E_evidence3, E_evidence4, E_evidence5, E_evidence6, E_evidence7)
CUFA_150_all_events_site5 <- c(CUFA_150_evidence1, CUFA_150_evidence2, CUFA_150_evidence3, CUFA_150_evidence4, CUFA_150_evidence5, CUFA_150_evidence6, CUFA_150_evidence7)
CUFA_nomin_all_events_site5 <- c(CUFA_nomin_evidence1, CUFA_nomin_evidence2, CUFA_nomin_evidence3, CUFA_nomin_evidence4, CUFA_nomin_evidence5, CUFA_nomin_evidence6, CUFA_nomin_evidence7)

E_count_site5 <- countevents(E_all_events_site5)
CUFA_150_count_site5 <- countevents(CUFA_150_all_events_site5)
CUFA_nomin_count_site5 <- countevents(CUFA_nomin_all_events_site5)

# Make one large data frame with all the data
E_site5 <- data.frame(prob = E_site5$prob, 
                      util_prob = E_util_site5, 
                      prob_diff = E_util_site5 - E_site5$prob, 
                      evidence = E_lengths_site5$evidence,
                      E_count_site5,
                      Q_bin = E_site5$Q_bin, 
                      scenario = E_site5$scenario)
CUFA_150_site5 <- data.frame(prob = CUFA_150_site5$prob, 
                             util_prob = CUFA_150_util_site5, 
                             prob_diff = CUFA_150_util_site5 - E_site5$prob, 
                             evidence = CUFA_150_lengths_site5$evidence, 
                             CUFA_150_count_site5,
                             Q_bin = CUFA_150_site5$Q_bin, 
                             scenario = CUFA_150_site5$scenario)
CUFA_nomin_site5 <- data.frame(prob = CUFA_nomin_site5$prob, 
                               util_prob = CUFA_nomin_util_site5,
                               prob_diff = CUFA_nomin_util_site5 - E_site5$prob,
                               evidence = CUFA_nomin_lengths_site5$evidence,
                               CUFA_nomin_count_site5,
                               Q_bin = CUFA_nomin_site5$Q_bin, 
                               scenario = CUFA_nomin_site5$scenario)
combined_site5 <- data.frame(rbind(E_site5, CUFA_150_site5, CUFA_nomin_site5), site = "site5")
